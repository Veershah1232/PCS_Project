...
user/_test_prio:     file format elf64-littleriscv
...
int main(){
  ...
  for(int i = 1; i <= 20; i++){
   ...
   e:	4955                	li	s2,21
    int pid = fork();
  10:	2f2000ef          	jal	302 <fork>

    if(pid == 0){
  14:	cd09                	beqz	a0,2e <main+0x2e>
  for(int i = 1; i <= 20; i++){
  16:	2485                	addiw	s1,s1,1
  18:	ff249ce3          	bne	s1,s2,10 <main+0x10>
  1c:	44a9                	li	s1,10
    }
  }
  ...
  exit(0);
  28:	4501                	li	a0,0
  2a:	2e0000ef          	jal	30a <exit>
      setpriority(getpid(), i);
  2e:	35c000ef          	jal	38a <getpid>
  32:	85a6                	mv	a1,s1
  34:	376000ef          	jal	3aa <setpriority>
  38:	4915                	li	s2,5
          for(volatile int i = 0; i < 10000; i++);
  3a:	6489                	lui	s1,0x2
  3c:	70f48493          	addi	s1,s1,1807 # 270f <base+0x16ff>
          printatomic(getpid());
  40:	34a000ef          	jal	38a <getpid>
  44:	36e000ef          	jal	3b2 <printatomic>
          for(volatile int i = 0; i < 10000; i++);
  48:	fc042e23          	sw	zero,-36(s0)
  4c:	fdc42783          	lw	a5,-36(s0)
  50:	2781                	sext.w	a5,a5
  52:	00f4cc63          	blt	s1,a5,6a <main+0x6a>
  56:	fdc42783          	lw	a5,-36(s0)
  5a:	2785                	addiw	a5,a5,1
  5c:	fcf42e23          	sw	a5,-36(s0)
  60:	fdc42783          	lw	a5,-36(s0)
  64:	2781                	sext.w	a5,a5
  66:	fef4d8e3          	bge	s1,a5,56 <main+0x56>
        for(int j = 0; j < 5; j++){ 
  6a:	397d                	addiw	s2,s2,-1
  6c:	fc091ae3          	bnez	s2,40 <main+0x40>
      exit(0);
  70:	4501                	li	a0,0
  72:	298000ef          	jal	30a <exit>
...
start(int argc, char **argv)
{
  ...
  r = main(argc, argv);
  7e:	f83ff0ef          	jal	0 <main>
  exit(r);
  82:	288000ef          	jal	30a <exit>
...
stat(const char *n, struct stat *st)
{
 ...
 1c6:	84aa                	mv	s1,a0
  ...
  r = fstat(fd, st);
 1c8:	85ca                	mv	a1,s2
 1ca:	198000ef          	jal	362 <fstat>
 1ce:	892a                	mv	s2,a0
  close(fd);
 1d0:	8526                	mv	a0,s1
 1d2:	160000ef          	jal	332 <close>
  return r;
 1d6:	64a2                	ld	s1,8(sp)
}
 1d8:	854a                	mv	a0,s2
...
00000000000003b2 <printatomic>:
.global printatomic
printatomic:
 li a7, SYS_printatomic
 3b2:	48dd                	li	a7,23
 ecall
 3b4:	00000073          	ecall
 ret
...
printint(int fd, long long xx, int base, int sgn)
{
 ...
 3f6:	50650513          	addi	a0,a0,1286 # 8f8 <digits>
 3fa:	883e                	mv	a6,a5
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 68c:	270b8b93          	addi	s7,s7,624 # 8f8 <digits>
 ...
 6ee:	20690913          	addi	s2,s2,518 # 8f0 <malloc+0xfa>
        for(; *s; s++)
